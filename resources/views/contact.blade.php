...
@section('container')
    <section class="margin-top">
            ...
            <div class="content p-3">
                ...
                <div class="row d-flex justify-content-between p-5">
                    <div class="col-7 px-5 mb-5" data-aos="fade-right">
                        <p class="text-white" style="font-size: 55px;">Contact </p>
                        <p class="text-white" style="text-align: justify; line-height: 1.1em; font-size:20px; width: 700px">
                            Home / <span style="color: var(--button)">Contact</span></p>
                    </div>
                </div>
        ...
        <div class="content row pt-5">
            <div class="col ps-5" data-aos="fade-right">
                <div class="p-5">
                    ...
                    <div class="row">
                        <div class="col-4 ">
                            <div class="card bg-contact me-3 " style="border-radius: 15px; border: 0 !important">
                                <div class="p-5">
                                    <div class="col p-3">
                                        <div class="row mb-4">
                        ...
                        <div class="col-8 ">
                            <div class="card bg-contact me-3" style="border-radius: 15px; border: 0 !important">
                                <iframe class="p-3" style="border-radius: 30px;"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d507418.6618726966!2d107.73457945!3d-6.4952914999999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e693e8d5e81b635%3A0x301e8f1fc28b940!2sSubang%20Regency%2C%20West%20Java!5e0!3m2!1sen!2sid!4v1687352056327!5m2!1sen!2sid"
