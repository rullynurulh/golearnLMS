                            ...
                            <div class="box-recommend px-5 pt-4 pb-4">
                                ...
                                <form action="#">
                                    <div class="form-group mb-3">
                                        <label class="form-label text-profile" style="font-size: 20px; margin-bottom:0" for="formpassword">Current Password
                                            </label><input type="password" name="password" id="formpassword"  value="none"
                                            class="form-control "  />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label class="form-label text-profile" style="font-size: 20px; margin-bottom:0" for="fornewpassword">New Password
                                            </label><input type="password" name="newpassword" id="fornewpassword" value="none"
                                            class="form-control "  />
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="form-label text-profile" style="font-size: 20px; margin-bottom:0" for="formconfirmpassword">Confirm Password
                                            </label><input type="password" name="confirmpassword" id="formconfirm" value="none"
                                            class="form-control "  />
                                    </div>
