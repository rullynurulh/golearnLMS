                            ...
                            <div class="box-recommend px-5 pt-4 pb-4">
                                <form action="#">
                                    <div class="form-group mb-2">
                                        <label class="form-label text-profile" style="font-size: 20px; margin-bottom:0" for="formname">My Name
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group mb-2">
                                                <label class="form-label text-profile" style="font-size: 20px; margin-bottom:0" for="formemail">My Email
                                        ...
                                        <div class="col">
                                            <div class="form-group mb-2">
                                                <label class="form-label text-profile" style="font-size: 20px; margin-bottom:0" for="formgender">Gender
                                    ...
                                    <div class="form-group mb-2">
                                        <label class="form-label text-profile" style="font-size: 20px; margin-bottom:0" for="formgender">Password
                                    ...
                                    <div class="form-group mb-2">
                                        <label class="form-label text-profile" style="font-size: 20px; margin-bottom:0" for="formemail">My Email
                                            </label><textarea type="text" name="email" id="formemail" value="none" style="resize:none; height:200px"
