            ...
            <div class="content p-3">
                ...
                <div class="row d-flex justify-content-between p-5">
                    <div class="col-7 px-5 mb-5" data-aos="fade-right">
                        <p class="text-white" style="font-size: 55px;">Courses </p>
                        <p class="text-white" style="text-align: justify; line-height: 1.1em; font-size:20px; width: 700px">
                            Home / <span style="color: var(--button)">Courses</span></p>
                    </div>
                </div>
                    ...
                    <div class="row p-5 d-flex justify-content-center">
                        @foreach ($courses as $course)
                            <div class="col-4 mb-2">
                                <div class="card text-left mx-5 my-3 ">
                                    <img class="card-img-top card-img-top-1" src="/{{ $course['image'] }}" alt="">
                                    <div class="card-body p-3">
                                        <div class="pb-3">
                                            <span class="iconify" data-icon="material-symbols:star" style="color: #fdcf73; "
                                                data-width="24"></span>
                                            <span class="iconify" data-icon="material-symbols:star"
                                                style="color: #fdcf73; margin-left: -5px" data-width="24"></span>
                                            <span class="iconify" data-icon="material-symbols:star"
                                                style="color: #fdcf73; margin-left: -5px" data-width="24"></span>
                                            ...
                                            <div class="col">
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col d-flex justify-content-between align-items-center"
                                                        ...
                                                        <span class=" text-left">{{ $course['instructor_name'] }}</span>
                                                        <div class="row pe-2">
                                                            <div class="col">
