                                        ...
                                        <div class="col">
                                            <form  action="/signup-role" method="post">
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" name="text" id="fromFullnameLogin"
                                                        class="form-control form-control-lg p-3" />
                                                </div>
                                                <!-- Password -->
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group mb-3">
                                                            <label class="form-label text-white" style="font-size: 23px" for="formPassLogin">Password
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group mb-3">
                                                            <label class="form-label text-white" style="font-size: 23px" for="formConfirmPassLogin">Confirm Password
                                                                </label><input type="password" name="confirm_password" id="formConfirmPassLogin"
                                                                class="form-control form-control-lg p-3"  />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <p class="text-end">Already Have an Account? <a href="/signin" style="text-decoration: none; color: var(--secondary4)">Sign In</a></p>
