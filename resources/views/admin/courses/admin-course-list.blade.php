                ...
                <div class="content p-5">
                    ...
                    <div class="row p-2 d-flex justify-content-between mb-3">
                        ...
                        <div class="col-4 d-flex justify-content-end">
                            ...
                            <a href="/admin/add-course" class="btn btn-add p-2"> <span class="iconify me-1" data-icon="el:plus-sign" data-width="24"></span> Add New Course</a>
                        </div>
                    </div>
                    <div class="box-recommend mt-2 p-4">
                        <div class="row d-flex justify-content-start ">
                            ...
                            <div class="col-1 d-flex justify-content-center"><h5 style="font-weight: 700">Categories</h5></div>
                            <div class="col-3 d-flex justify-content-center"><h5 style="font-weight: 700">Course Title</h5></div>
                            <div class="col-2 d-flex justify-content-center"><h5 style="font-weight: 700">Course Code</h5></div>
                            <div class="col-2 d-flex justify-content-center"><h5 style="font-weight: 700">Instructor</h5></div>
                            <div class="col-1 d-flex justify-content-center"><h5 style="font-weight: 700">Lesson</h5></div>
                            <div class="col-1 d-flex justify-content-center"><h5 style="font-weight: 700">Enrolled</h5></div>
                        ...
                        <div class="row d-flex justify-content-start mb-3">
                            ...
                            <div class="col-1 d-flex justify-content-center align-items-center">
                                <h5 style="font-weight: 500; margin-bottom:0">Categories1</h5>
                            </div>
                            <div class="col-3 d-flex justify-content-center align-items-center">
                                <h5 style="font-weight: 500; margin-bottom:0">Course1</h5>
                            </div>
                            <div class="col-2 d-flex justify-content-center align-items-center">
                                <h5 style="font-weight: 500; margin-bottom:0">123123</h5>
                            </div>
                            <div class="col-2 d-flex justify-content-center align-items-center">
                                <h5 style="font-weight: 500; margin-bottom:0">Instructor1</h5>
                            </div>
                            <div class="col-1 d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-1 d-flex justify-content-center align-items-center">
                                <div class="col d-flex justify-content-center align-items-center">
                                        ...
                                        <a href="/admin/edit-course" style="border: none; background-color:#EAEAEA;"> <span class="iconify me-1" data-icon="fa-solid:edit" data-width="27"></span></a>
                                        |
