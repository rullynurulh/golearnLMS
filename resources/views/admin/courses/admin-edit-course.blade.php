                ...
                <div class="content p-5">
                    ...
                    <div class="row p-2 d-flex justify-content-between mb-3">
                        <div class="col-3 d-flex align-items-center">
                            <h4 style="margin-bottom:0">Course 1</h4>
                        </div>
                        ...
                        <div class="box-recommend mt-2 p-4">
                            <div class="row d-flex justify-content-start ">
                                <div class="add-new-course">
                                    <button class="collapsible-chapter btn-add-chapter"> <span class="iconify me-1" data-icon="el:plus-sign" data-width="24"></span> Add Chapter</button>
                            ...
                            <div class="box-list-admin mb-2">
                                <div class="row d-flex justify-content-start">
                                    ...
                                    <div class="col-9 d-flex justify-content-start align-items-center">
                                        <h5 style="font-weight: 500; margin-bottom:0">Chapter 1</h5>
                                    </div>
                                    <div class="col-2 d-flex justify-content-end align-items-center">
                                        <div class="col d-flex justify-content-end align-items-center">
                                                ...
                                                |
                                                <a href="/admin/add-curriculum" style="border: none;"> <span class="iconify ms-2" data-icon="mingcute:add-fill" style="color: black;" data-width="25"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
