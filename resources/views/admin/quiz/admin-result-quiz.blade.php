                ...
                <div class="content p-5">
                    ...
                    <div class="box-recommend mt-2 p-4">
                        <div class="row d-flex justify-content-start ">
                            ...
                            <div class="col-3 d-flex justify-content-center"><h5 style="font-weight: 700">Student</h5></div>
                            <div class="col-2 d-flex justify-content-center"><h5 style="font-weight: 700">Status</h5></div>
                            <div class="col-2 d-flex justify-content-center"><h5 style="font-weight: 700">Result</h5></div>
                            <div class="col-2 d-flex justify-content-center"><h5 style="font-weight: 700">Duration</h5></div>
                        ...
                        <div class="row d-flex justify-content-start mb-2">
                            ...
                            <div class="col-2 d-flex justify-content-center align-items-center">
                                <h5 style="font-weight: 500">Done</h5>
                            </div>
                            <div class="col-2 d-flex justify-content-center align-items-center">
                                <h5 style="font-weight: 500">90%</h5>
                            </div>
                            <div class="col-2 d-flex justify-content-center align-items-center">
                                <h5 style="font-weight: 500">100</h5>
                            </div>
                            <div class="col-2 d-flex justify-content-center align-items-center">
