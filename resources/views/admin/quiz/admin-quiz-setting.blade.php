                        ...
                        <form  action=""  enctype="multipart/form-data">
                            <div class="col mb-3">
                                <div class="form-group mb-2">
                                    <label for="form-label text-white" style="font-size: 20px">Max Student Can Use Help Mode</label>
                                    <input type="number" name="max_help_mode" id="max_help_mode"
                                        class="form-control "/>
                                </div>
                            </div>
                            <div class="col mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="flexSwitchCheckDefault" style="font-size: 20px">Random Number</label>
                                </div>
                            ...
                            <div class="col mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
                                    <label class="form-check-label" for="flexSwitchCheckDefault" style="font-size: 20px">Multiple Attend</label>
                                </div>
