...
@section('container')
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <div class="box-recommend mt-2 p-4" style="overflow: scroll; max-height: 720px">
                                <form action="{{ route('admin_save_certificate_setting') }}" id="Inputs"
                                    class="form_certificate" enctype="multipart/form-data" method="POST">
                                    @csrf
                                    <div class="col">
                                            ...
                                            <div class="row form-group mb-2">
                                                ...
                                                <div class="col-3 form-radio d-flex align-items-center">
                                                    <input class="form-radio-input me-2" type="radio" name="show_logo"
                                                        id="show_logo_yes"
                                                        {{ $certificate['show_logo'] == 'yes' ? 'checked' : '' }}
                                                        value="yes">
                                                ...
                                                <div class="col-3 form-radio d-flex align-items-center">
                                                    <input class="form-radio-input me-2" type="radio" name="show_logo"
                                                        id="show_logo_no"
                                                        {{ $certificate['show_logo'] == 'no' ? 'checked' : '' }}
                                                        value="no">
                                                ...
                                                <div class="col">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <input type="number" name="position_logo_x" id="position_logo_x"
                                                            ...
                                                            value="{{ $certificate['show_logo'] == 'yes' ? $certificate['position_logo_x'] : '1675' }}" />
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <input type="number" name="position_logo_y" id="position_logo_y"
                                                            class="form-control px-3 py-2 certinputs"
                                                            value="{{ $certificate['show_logo'] == 'yes' ? $certificate['position_logo_y'] : '110' }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                        <div class="col">
                                            <div class="row form-group mb-2">
                                                <label for="show_logo_yes" class="form-label"
                                                    style="font-size: 23px">Show
                                                    Logo</label>
                                                <div class="col-3 form-radio d-flex align-items-center">
                                                    <input class="form-radio-input me-2" type="radio" name="show_logo"
                                                        id="show_logo_yes" checked value="yes">
                                                    <label class="form-radio-label" for="show_logo_yes">
                                                        YES
                                                    </label>
                                                </div>
                                    ...
                                    @if ($certificate)
                                            ...
                                            <div class="row form-group mb-2">
                                                ...
                                                <div class="col-3 form-radio d-flex align-items-center">
                                                    <input class="form-radio-input me-2" type="radio"
                                                        name="show_student" id="show_student_yes"
                                                        {{ $certificate['show_student'] == 'yes' ? 'checked' : '' }}
                                                        value="yes">
                                                ...
                                                <div class="col-3 form-radio d-flex align-items-center">
                                                    <input class="form-radio-input me-2" type="radio"
                                                        name="show_student" id="show_student_no"
                                                        {{ $certificate['show_student'] == 'no' ? 'checked' : '' }}
                                                        value="no">
                                                ...
                                                <div class="col">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <input type="number" name="position_student_x"
                                                            id="position_student_x"
                                                            class="form-control px-3 py-2 certinputs"
                                                            value="{{ $certificate['show_student'] == 'yes' ? $certificate['position_student_x'] : '50' }}" />
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <input type="number" name="position_student_y"
                                                            id="position_student_y"
                                                            class="form-control px-3 py-2 certinputs"
                                                            value="{{ $certificate['show_student'] == 'yes' ? $certificate['position_student_y'] : '30' }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group mb-2">
                                                <label for="font_size" class="form-label" style="font-size: 23px">Font
                                                    Size
                                                </label>
                                    ...
                                    @else
                                        <div class="col">
                                            <div class="row form-group mb-2">
                                                ...
                                                <div class="col-3 form-radio d-flex align-items-center">
                                                    <input class="form-radio-input me-2" type="radio"
                                                        name="show_student" id="show_student_yes" checked value="yes">
                                                    <label class="form-radio-label" for="show_student_yes">
                                                        YES
                                                    </label>
                                                </div>
                                                <div class="col-3 form-radio d-flex align-items-center">
                                                    <input class="form-radio-input me-2" type="radio"
                                                        name="show_student" id="show_student_no" value="no">
                                                    <label class="form-radio-label" for="show_student_no">
                                                        NO
                                                    </label>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <input type="number" name="position_student_x"
                                                            id="position_student_x"
                                                            class="form-control px-3 py-2 certinputs" value="50" />
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group mb-2">
                                    ...
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" data-x="50" data-y="20" name="text_1"
                                                ...
                                                value="{{ $certificate ? $certificate['text_1'] : 'Proudly Presented To' }}" />
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" data-x="50" data-y="40" name="text_2"
                                                ...
                                                value="{{ $certificate ? $certificate['text_2'] : 'For The Successful Completion Of' }}" />
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group mb-2">
                                    ...
                                    <div class="col">
                                        <div class="row form-group mb-2">
                                            ...
                                            <div class="col-3 form-radio d-flex align-items-center">
                                                <input class="form-radio-input me-2" type="radio" name="show_course"
                                                    id="show_course_name_yes"
                                                    {{ $certificate && $certificate['show_course'] == 'yes' ? 'checked' : '' }}
                                                    value="yes" required>
                                            ...
                                            <div class="col-3 form-radio d-flex align-items-center">
                                                <input class="form-radio-input me-2" type="radio" name="show_course"
                                                    id="show_course_name_no"
                                                    {{ $certificate && $certificate['show_course'] == 'no' ? 'checked' : '' }}
                                                    value="no" required>
                                        ...
                                        <div class="row form-group mb-2">
                                            ...
                                            <div class="col-3 form-radio d-flex align-items-center">
                                                <input class="form-radio-input me-2" type="radio" name="show_date"
                                                    id="show_date_yes"
                                                    {{ $certificate && $certificate['show_date'] == 'yes' ? 'checked' : '' }}
                                                    value="yes" required>
                                            ...
                                            <div class="col-3 form-radio d-flex align-items-center">
                                                <input class="form-radio-input me-2" type="radio" name="show_date"
                                                    id="show_date_no"
                                                    {{ $certificate && $certificate['show_date'] == 'no' ? 'checked' : '' }}
                                                    value="no" required>
                                            ...
                                            <div class="col">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="number" name="signature_height" id="signature_height"
                                                        class="form-control px-3 py-2 certinputs"
                                                        value="{{ $certificate ? $certificate['signature_height'] : '150' }}" />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="number" name="signature_width" id="signature_width"
                                                        class="form-control px-3 py-2 certinputs"
                                                        value="{{ $certificate ? $certificate['signature_width'] : '150' }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function drawTextfromInputs() {
            ...
            var text3 =
                "Lorem ipsum dolor sit amet consectetur. Tristique in in velit malesuada. Diam morbi ullamcorper dictum faucibus urna ut vestibulum pharetra arcu."
