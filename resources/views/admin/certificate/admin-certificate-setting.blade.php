                                ...
                                <form action="" id="Inputs" class="form_certificate" enctype="multipart/form-data" >
                                    ...
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            <label for="background_image" class="form-label " style="font-size: 23px">Background Image Default</label>
                                            <input type="file" value="Upload Image" accept="image/*" name="background_image" id="background_image" class="form-control px-3 py-2"/>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="row form-group mb-2">
                                            <label for="show_logo_yes"  class="form-label" style="font-size: 23px">Show Logo</label>
                                    ...
                                    <div class="col">
                                        <div class="row form-group mb-2">
                                            <div class="col">
                                                <div class="form-group mb-2">
                                                    <label for="position_logo_x" class="form-label" style="font-size: 23px">Position X
                                                    </label>
                                                    <input type="number" name="position_logo_x" id="position_logo_x" class="form-control px-3 py-2"
                                                        />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group mb-2">
                                                    <label for="position_logo_y" class="form-label" style="font-size: 23px">Position Y
                                                    </label>
                                                    <input type="number" name="position_logo_y" id="position_logo_y" class="form-control px-3 py-2"
                                                        />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="row form-group mb-2">
                                            <label for="show_student_yes" class="form-label" style="font-size: 23px">Student Name</label>
                                            <div class="col-3 form-radio d-flex align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="row form-group">
                                            <div class="col">
                                                <div class="form-group mb-2">
                                                    <label for="position_student_x" class="form-label" style="font-size: 23px">Position X
                                                    </label>
                                                    <input type="number" name="position_student_x" id="position_student_x" class="form-control px-3 py-2"
                                                        />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group mb-2">
                                                    <label for="position_student_y" class="form-label" style="font-size: 23px">Position Y
                                                    </label>
                                                    <input type="number" name="position_student_y" id="position_student_y" class="form-control px-3 py-2"
                                                        />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="number" name="font_size" id="font_size" class="form-control px-3 py-2"
                                                placeholder="30"/>
                                        </div>
                                    </div>
                                    <hr class="my-3" style="opacity: 1; border: 1px solid white; margin:0">
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" data-x="50" data-y="40" name="text_1" id="text_1" data-font="Roboto" data-fontsize="3" 
                                    ...
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" data-x="50" data-y="60" name="text_2" id="text_2" data-font="Roboto" data-fontsize="2"  class="text_2 form-control px-3 py-2 certinputs"
                                    ...
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            <label for="body_position" class="form-label" style="font-size: 23px">Body Position
                                            </label>
                                            <select type="select" name="body_position" id="body_position" class="form-select px-3 py-2">
                                    ...
                                    <div class="col">
                                        <div class="row form-group mb-2">
                                            <label for="show_course_name_yes" class="form-label" style="font-size: 23px">Show Course Name</label>
                                            <div class="col-3 form-radio d-flex align-items-center">
                                                <input class="form-radio-input me-2" type="radio" name="show_course_name"
                                                    id="show_course_name_yes" checked value="yes_course_name">
                                            ...
                                            <div class="col-3 form-radio d-flex align-items-center">
                                                <input class="form-radio-input me-2" type="radio" name="show_course_name"
                                                    id="show_course_name_no"  value="no_course_name">
                                    ...
                                    <div class="col">
                                        <div class="row form-group mb-2">
                                            <label for="show_date_yes" class="form-label" style="font-size: 23px">Show Date</label>
                                            <div class="col-3 form-radio d-flex align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            <label for="footer_title" class="form-label" style="font-size: 23px">Footer Title
                                            </label>
                                            <select type="select" data-x="50" data-y="88" data-font="Roboto" data-fontsize="2"  name="footer_title" id="footer_title" class="text_3 form-select px-3 py-2 certinputs"
                                                >
                                    ...
                                    <div class="col">
                                        <div class="form-group mb-2">
                                            <label for="signature" class="form-label" style="font-size: 23px">Signature Image</label>
                                    ...
                                    <div class="col">
                                        <div class="row form-group">
                                            <div class="col">
                                                <div class="form-group mb-2">
                                                    <label for="signature_height" class="form-label" style="font-size: 23px">Signature Height
                                                    </label>
                                                    <input type="number" name="signature_height" id="signature_height" class="form-control px-3 py-2"
                                                        />
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group mb-2">
                                                    <label for="signature_width" class="form-label" style="font-size: 23px">Signature Width
                                                    </label>
                                                    <input type="number" name="signature_width" id="signature_width" class="form-control px-3 py-2"
                                                        />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end pt-1 mb-1">
                                        ...
                                        <button id="save_and_download" class="btn btn-button btn-shadow text-dark px-5 rounded-pill "
