...
@section('container')
    <section class="margin-top">
        @if ($home)
            ...
            @else
                <div class="bg-image-jumbotron"
                    style="padding-bottom: 9rem; background: linear-gradient(0deg, rgba(65, 89, 137, 0.5), rgba(65, 89, 137, 0.5)), url('images/bg-slider.jpg');">
        @endif
                    ...
                    @if (!$home)
                        <div class="col-7 px-5 mb-5" data-aos="fade-right">
                            ...
                            <p class="text-white"
                                ...
                                Lorem ipsum dolor sit amet consectetur. Eros ullamcorper consectetur pretium egestas turpis.
                                Mattis ornare vitae enim a sit accumsan.</p>
                        </div>
                    @else
                        <div class="col-7 px-5 mb-5" data-aos="fade-right">
        ...
        @if ($home && $home['about_us_section_in_home_page'] == 'yes')
            <div class="content row pt-5">
                ...
                <div class="col-8">
                    <div data-aos="fade-left">
                        ...
                        @else
                            <h4 style="font-size: 25px; font-weight: 400; text-align: justify;"> Lorem ipsum dolor sit amet
                                consectetur adipisicing elit. Blanditiis molestiae possimus eveniet.
                                Voluptate earum, repudiandae laboriosam, corporis animi quas vel magnam nulla explicabo
                                maxime
                                porro
                                minima ipsum, aliquid delectus placeat.
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. A nihil odit quisquam distinctio
                                voluptatibus doloribus,
                                temporibus unde esse, perspiciatis nulla veritatis commodi necessitatibus laudantium, quod
                                voluptatem adipisci
                                aperiam est animi.
                                <br><br>
            ...
            <div class="content row pt-5">
                ...
                <div class="col-8">
                    <div data-aos="fade-left">
                        <h4 style="font-size: 25px; font-weight: 400; text-align: justify;"> Lorem ipsum dolor sit amet
                            consectetur adipisicing elit. Blanditiis molestiae possimus eveniet.
                            Voluptate earum, repudiandae laboriosam, corporis animi quas vel magnam nulla explicabo maxime
                            porro
                            minima ipsum, aliquid delectus placeat.
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. A nihil odit quisquam distinctio
                            voluptatibus doloribus,
                            ...
                            voluptatem adipisci
                            aperiam est animi.
                            <br><br> Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis molestiae possimus
                            eveniet.
                            Voluptate earum, repudiandae laboriosam, corporis animi quas vel magnam nulla explicabo maxime
                            porro
                            minima ipsum, aliquid delectus placeat.
                                ...
                                <div class="swiper mt-5 px-3" style="margin-right: 0px">
                                    ...
                                    @else
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card text-left">
                                                    <img class="card-img-top card-img-top-1" src="images/course.jpg"
                                                        alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Title</h4>
                                                        <p class="card-text">Body</p>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card text-left">
                                                    <img class="card-img-top card-img-top-1" src="images/placeholder.png"
                                                        alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Title</h4>
                                                        <p class="card-text">Body</p>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card text-left">
                                                    <img class="card-img-top card-img-top-1" src="holder.js/100px180/"
                                                        alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Title</h4>
                                                        <p class="card-text">Body</p>
                            ...
                            @else
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="box-teacher-name m-auto">
                                            <div class="col p-2">
                                                <h5 class="pt-2">Prof. Jeon Wonwoo</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
